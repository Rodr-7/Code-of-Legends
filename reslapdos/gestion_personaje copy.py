...
class PerfilArma:
    def __init__(self, nombre_arma, arma=None, archivocsv="armas.csv"):
...
class PerfilPersonaje: 
    def __init__(self, nombre_personaje, personaje=None,archivocsv="personajes.csv"):
...
#----------------------------------------------------  PRUEBAS  ---------------------------------------------------------------------------------------------------------------------------------
"""
mi_personaje = PerfilPersonaje("Cloud")
mi_personaje.leer_personaje()
#mi_personaje.subir_niveles(1)
print(mi_personaje.personaje)
